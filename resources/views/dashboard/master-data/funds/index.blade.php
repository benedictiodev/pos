...
@section('main')
                  ...
                  @foreach ($data as $item)
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                      ...
                      <td class="whitespace-nowrap p-4 text-sm font-normal text-gray-500 dark:text-gray-400">
                        <p class="text-sm font-normal text-gray-900 dark:text-white">{{ $item->type }}</p>
                      </td>
                      ...
                      <td class="text-center space-x-2 whitespace-nowrap p-4">
                        ...
                        <button type="button" id="deleteProductButton"
                          data-drawer-target="drawer-delete-fund-default"
                          data-drawer-show="drawer-delete-fund-default"
                          aria-controls="drawer-delete-fund-default" data-drawer-placement="right"
  ...
  <div id="drawer-delete-fund-default"
    ...
    <button type="button" data-drawer-dismiss="drawer-delete-fund-default"
      aria-controls="drawer-delete-fund-default"
    ...
    <form id="form-delete">
      ...
      <h3 class="mb-6 text-lg text-gray-500 dark:text-gray-400">Are you sure you want to delete this fund?</h3>
