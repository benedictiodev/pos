...
@section('main')
  <div class="">
    <div class="mb-4">
      ...
      <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl mb-4">Pembaruan Tipe Dana</h1>
    ...
    <div
      ...
      <div class="mb-4">
        <form action="{{ route('dashboard.master-data.funds.update', ['id' => $data->id]) }}" method="POST">
          @csrf
          @method('PUT')
          <div class="space-y-4">
            <div class="mb-4">
              <label for="type" class="mb-2 block text-sm font-medium text-gray-900">Nama Tipe Dana</label>
              <input type="text" name="type" id="type" value="{{ old('type', $data->type) }}"
