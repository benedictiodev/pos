...
@section('main')
  <div class="">
      ...
      <nav class="mb-5 flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
          ...
          <li>
            <div class="flex items-center">
              <x-fas-chevron-right class="h-3 w-3 text-gray-400" />
              <span class="ml-1 text-gray-400 md:ml-2" aria-current="page">Category
                Products</span>
            </div>
          </li>
        </ol>
      </nav>
      <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl mb-4">Create Product</h1>
    ...
    <div
      ...
      <div class="mb-4">
        <form action="{{ route('dashboard.master-data.category-product.post') }}" method="POST">
          @csrf
          <div class="space-y-4">
            <div>
              <label for="name" class="mb-2 block text-sm font-medium text-gray-900">Category
                Name</label>
