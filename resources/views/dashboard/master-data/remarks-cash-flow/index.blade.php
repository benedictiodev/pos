        ...
        <nav class="mb-5 flex" aria-label="Breadcrumb">
          <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
            ...
            <li>
              <div class="flex items-center">
                <x-fas-chevron-right class="h-3 w-3 text-gray-400" />
                <span class="ml-1 text-gray-400 md:ml-2" aria-current="page">Keterangan Arus Kas</span>
              </div>
            </li>
          </ol>
        </nav>
        <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">Keterangan Arus Kas</h1>
      </div>
    </div>
          ...
          <form class="sm:pr-3" action="{{ route('dashboard.master-data.remarks-cash-flow') }}" method="GET">
            ...
            <div class="relative mt-1 w-48 sm:w-64 xl:w-96">
              <input type="text" name="search" id="search"
                ...
                placeholder="Cari Keterangan Arus Kas" @if (isset($_GET['search'])) value="{{ $_GET['search'] }}" @endif>
            </div>
          </form>
            ...
            <div class="overflow-hidden shadow rounded-t-lg">
              <table class="min-w-full table-fixed divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  ...
                  @empty
                    <tr>
                      <td class="text-center text-base font-light p-4" colspan="4">Data Kosong</td>
                    </tr>
                  @endforelse
                </tbody>
              </table>
