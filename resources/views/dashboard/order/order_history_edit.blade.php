      ...
      <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
          ...
          <div class="p-4 md:p-5 space-y-4">
            ...
            <form id="form-confirm_order"
              action="{{ route('dashboard.order.order_history_update', ['id' => $order->id]) }}" method="POST" hidden>
              @csrf
              @method('PUT')
        ...
        if (data_order[index].id) {
          ...
          if (index_update >= 0) {
            data_order_update[index_update] = {
              id: data_order_add[index_update].id,
              product_id,
              product_price,
              product_name,
              qty,
          ...
          data_order_add[index_add] = {
            id: data_order_add[index_add].id,
            product_id,
            product_price,
            product_name,
            qty,
