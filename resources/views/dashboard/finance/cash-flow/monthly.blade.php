              ...
              <table class="min-w-full table-fixed divide-y divide-gray-200 mb-10 border-b">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  @if  ($type_closing_cycle == 'found')
                    <tr>
                      <td scope="col"
                        class="p-4 text-left text-base font-normal uppercase text-black">
                        Equite :
                      </td>
                      <td scope="col"
                        class="p-4 text-right text-base font-semibold uppercase text-black">
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow">
        ...
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
          ...
          <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="modal-add-equite">
          ...
          <form action="{{ route('dashboard.finance.equite.post') }}" method="POST" id="form-add_equite">
            ...
            <div id="payment_form" class="border pl-4 pr-2 pt-4 pb-2 rounded-lg relative mb-3">
              ...
              @foreach ($fund as $item_fund)  
                <label for="equite" class="mb-2 block text-sm font-medium text-gray-900">Equite - {{ $item_fund->type }}</label>
        ...
        <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b">
          <button type="submit" form="form-add_equite" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Yes, I'm suret</button>
          <button data-modal-hide="modal-add-equite" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">No, Cancel</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow">
        ...
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
          ...
          <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="modal-closing-cycle">
            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
            </svg>
            <span class="sr-only">Close modal</span>
          ...
          <form action="{{ route('dashboard.finance.equite.closing') }}" method="POST" id="form-closing_cycle">
              ...
              <div class="flex">
                ...
                <div class="w-1/3">
                  ...
                  <input type="number" name="profit" id="profit"
                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600"
                    placeholder="Profit" value="{{ $total_amount - ($closing_cycle ? $closing_cycle->equity : 0) }}" readonly>
                </div>
              </div>
            </div>
            <div class="flex items-center mb-3">
              <input name="set_equity" id="set_equity" type="checkbox" value="check" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2">
            ...
            <div class="mb-3" id="next_equite_form" hidden>
              ...
              <div id="payment_form" class="border pl-4 pr-2 pt-4 pb-2 rounded-lg relative mb-3">
                ...
                @foreach ($fund as $item_fund)  
                  <label for="next_equite" class="mb-2 block text-sm font-medium text-gray-900">Equite - {{ $item_fund->type }}</label>
        ...
        <!-- Modal footer -->
        <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b">
          <button type="submit" form="form-closing_cycle" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Yes, I'm suret</button>
          <button data-modal-hide="modal-closing-cycle" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">No, Cancel</button>
        </div>
      </div>
    </div>
  </div>
