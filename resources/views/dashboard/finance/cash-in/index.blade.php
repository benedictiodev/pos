        ...
        <nav class="mb-5 flex" aria-label="Breadcrumb">
          <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
            ...
            <li>
              <div class="flex items-center">
                <x-fas-chevron-right class="h-3 w-3 text-gray-400" />
                <span class="ml-1 text-gray-400 md:ml-2" aria-current="page">Cash In</span>
              </div>
            </li>
          </ol>
        </nav>
        <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">Cash In</h1>
      </div>
    </div>
            ...
            <div class="overflow-hidden shadow">
              <table class="min-w-full table-fixed divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  @forelse ($data as $item)
                    <tr class="hover:bg-gray-100">
                      ...
                      <td class="whitespace-nowrap p-4 text-sm font-normal text-gray-500">
                        <p class="text-base font-semibold text-gray-900">{{ $item->fund }}
                        </p>
                      </td>
                      <td class="whitespace-nowrap p-4 text-sm font-normal text-gray-500">
                        <p class="text-base font-semibold text-gray-900">{{ $item->remark }}
                        </p>
                      </td>
                      <td class="whitespace-nowrap p-4 text-sm font-normal text-gray-500">
                        <p class="text-base font-semibold text-gray-900">{{ $item->datetime }}
                        </p>
                      </td>

                      <td class="space-x-2 whitespace-nowrap p-4">
                        <a href="{{ route('dashboard.finance.cash-in.edit', ['id' => $item->id]) }}"
                  ...
                  @empty
                    <tr>
                      <td class="text-center text-base font-light p-4" colspan="5">Empty Data</td>
                    </tr>
                  @endforelse
                </tbody>
              </table>
