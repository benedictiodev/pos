...
@section('main')
  <div class="">
    <div class="mb-4">
      ...
      <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl mb-4">Create Cash In</h1>
    ...
    <div
      class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2">
      <div class="mb-4">
        <form action="{{ route('dashboard.finance.cash-in.post') }}" method="POST">
          @csrf
          <div class="space-y-6">
            <div>
