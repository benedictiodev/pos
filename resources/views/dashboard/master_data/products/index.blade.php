        ...
        <nav class="mb-5 flex" aria-label="Breadcrumb">
          <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
            ...
            <li>
              <div class="flex items-center">
                <x-fas-chevron-right class="h-3 w-3 text-gray-400" />
                <span class="ml-1 text-gray-400 dark:text-gray-500 md:ml-2" aria-current="page">Products</span>
              </div>
            </li>
          </ol>
        </nav>
        <h1 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">All Products</h1>
      </div>
    </div>
    ...
    <div
      ...
      <div class="block items-center justify-between dark:divide-gray-700 sm:flex md:divide-x md:divide-gray-100 mb-4">
        ...
        <a id="createProductButton"
          ...
          type="button" href="{{ route('dashboard.master-data.products.create') }}">
          Add new product
        </a>
      </div>
                  ...
                  @foreach ($data as $item)
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                      ...
                      <td class="space-x-2 whitespace-nowrap p-4">
                        <a href="{{ route('dashboard.master-data.products.show', ['id' => $item->id]) }}" type="button"
