        ...
        <nav class="flex mb-5" aria-label="Breadcrumb">
          <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
            ...
            <li>
              <div class="flex items-center">
                <x-fas-chevron-right class="w-3 h-3 text-gray-400" />
                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Category Products</span>
              </div>
            </li>
          </ol>
        </nav>
        <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All category products</h1>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="bottom-0 left-0 flex justify-center w-full pb-4 space-x-4 md:px-4 md:absolute">
          ...
          <button type="button" data-drawer-dismiss="drawer-create-product-default"
            ...
            <x-fas-x aria-hidden="true" class="w-5 h-5 -ml-1 sm:mr-1" />
            Cancel
          </button>
        </div>
    </form>
