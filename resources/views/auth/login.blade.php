      ...
      <form class="mt-8 space-y-6" action="{{ route('post_login') }}" method="POST">
        ...
        <div>
          ...
          <input type="email" name="email" id="email"
            class="border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5"
        ...
        <button type="submit"
          class="w-full shadow-lg px-5 py-3 text-base font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto">
          Masuk ke akun Anda
        </button>
        {{-- <button type="button"
