    ...
    <div class="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-2xl shadow-2xl">
      ...
      <form class="mt-8 space-y-6" action="{{ route('post_login') }}" method="POST">
        ...
        <div class="flex items-end">
          ...
          <a href="#" class="ml-auto text-sm text-primary-700 hover:underline">Lost
            Password?</a>
        </div>
        <button type="submit"
          class="w-full px-5 py-3 text-base font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto">Login
